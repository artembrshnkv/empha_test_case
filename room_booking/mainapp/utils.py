...
def get_available_room_numbers(reservation_time):
    ...
    for room in all_booked_rooms_dates:
        if not reservation_time['start_reservation'] < room['start_reservation'] and \
                reservation_time['end_reservation'] < room['start_reservation'] or \
                reservation_time['start_reservation'] > room['end_reservation'] and \
                reservation_time['end_reservation'] > room['end_reservation']:
